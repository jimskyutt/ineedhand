...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="maincont min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div class=" cont {{ $containerWidth ?? 'w-[800px]' }} px-6 p-4 mt-6 mb-6 bg-white  shadow-md overflow-hidden sm:rounded-lg">
                @yield('content')
            </div>
        </div>
        @stack('scripts')
